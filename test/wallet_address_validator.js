...
describe("WAValidator.validate()", function () {
    describe("valid results", function () {
        ...
        it("should return true for correct ton addresses", function () {
            valid("Ef_mlXHnufWO3-vvopflR_NpIFMiidvp_xt20Qf8usMBBKzB", "ton");
            valid("EQBP4mzpDIywL1SV-Wp9ZuBBlzprR9eXQgSYGEXiUEHm7yYF", "ton");
            valid("Ef9e6tkwtIJjt9pK4dJ-2M1dmNvFOB_mvaWMtElU61oj5_Dx", "ton");
        });
    });
